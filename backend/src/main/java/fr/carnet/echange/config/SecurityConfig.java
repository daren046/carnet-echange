...
import fr.carnet.echange.filter.JwtAuthFilter;
import fr.carnet.echange.service.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .exceptionHandling(exc -> exc.authenticationEntryPoint((request, response, authException) -> {
                    ...
                    response.getWriter().write("{\"success\":false,\"message\":\"Non autorisé\"}");
                }))
